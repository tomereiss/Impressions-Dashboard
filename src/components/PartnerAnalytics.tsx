    ...
    try {
      ...
      for (const date of availableDates) {
        try {
          ...
          const impressionsResponse = await fetch(`http://localhost:3001/api/impressions-count/${date}`);
          ...
          const violationsResponse = await fetch(`http://localhost:3001/api/bad-impressions/${date}`);
